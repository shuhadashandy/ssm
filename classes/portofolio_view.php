 ...
 * Page class
 */
class portofolio_view extends portofolio
{
	...
	// Page object name
	public $PageObjName = "portofolio_view";
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "portofoliolist.php"; // No matching record, return to list
					} else {
						$this->loadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$returnUrl = "portofoliolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
