 ...
 * Page class
 */
class tentang_delete extends tentang
{
	...
	// Page object name
	public $PageObjName = "tentang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tentanglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tentanglist.php"); // Return to list
			}
		}
	}
