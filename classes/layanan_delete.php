 ...
 * Page class
 */
class layanan_delete extends layanan
{
	...
	// Page object name
	public $PageObjName = "layanan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("layananlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("layananlist.php"); // Return to list
			}
		}
	}
