...
class index
{
	...
	public function run()
	{
		...
		if (!$Security->isLoggedIn())
			$Security->autoLogin();
		if ($Security->isLoggedIn())
			$this->terminate("tentanglist.php"); // Exit and go to default page
		if ($Security->isLoggedIn())
			$this->terminate("layananlist.php");
		if ($Security->isLoggedIn())
			$this->terminate("portofoliolist.php");
		if ($Security->isLoggedIn())
			$this->terminate("kontaklist.php");
		if ($Security->isLoggedIn())
			$this->terminate("footerkirilist.php");
		if ($Security->isLoggedIn()) {
