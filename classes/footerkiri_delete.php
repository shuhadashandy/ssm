 ...
 * Page class
 */
class footerkiri_delete extends footerkiri
{
	...
	// Page object name
	public $PageObjName = "footerkiri_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("footerkirilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("footerkirilist.php"); // Return to list
			}
		}
	}
