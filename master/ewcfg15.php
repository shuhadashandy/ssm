...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "SsmPT"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'aTWXsRBAg0QB71zy'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/SsmPT.css"); // Project stylesheet file name
...
$PROJECT_ID = "{65C86988-D9B3-45F3-BFE9-EBEAEDC157CE}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "ssm", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "ssmsmd"); // Administrator user name
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "sy4mSury4999"); // Administrator password
