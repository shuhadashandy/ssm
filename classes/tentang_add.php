 ...
 * Page class
 */
class tentang_add extends tentang
{
	...
	// Page object name
	public $PageObjName = "tentang_add";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canAdd()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("tentanglist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("tentanglist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "tentanglist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "tentangview.php")
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if ($this->Gambar->UseColorbox) {
				...
				$this->Gambar->LinkAttrs["data-rel"] = "tentang_x_Gambar";
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("tentanglist.php"), "", $this->TableVar, TRUE);
