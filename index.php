            ...
            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
              <div class="row">
                <div class="col-md-6 form-group">
                    <input type="text" name="Nama" class="form-control" value="" size="75" placeholder="Your Name">
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                    <input type="text" name="Email" class="form-control" value="" size="75" placeholder="E-Mail">
                </div>
              </div>
              <div class="form-group mt-3">
                    <input type="text" name="Judul" class="form-control" value="" size="75" placeholder="Subject">
              </div>
              <div class="form-group mt-3">
                    <textarea class="form-control" name="Isi" cols="75" rows="5" placeholder="Messages"></textarea>
              </div>
              <div class="my-3">
                <div class="text-center"><input type="submit" value="Send Messages"></div>
