...
/**
 * Table class for tentang
 */
class tentang extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tentang';
		$this->TableName = 'tentang';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tentang`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new DbField('tentang', 'tentang', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Judul
		$this->Judul = new DbField('tentang', 'tentang', 'x_Judul', 'Judul', '`Judul`', '`Judul`', 200, -1, FALSE, '`Judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Gambar
		$this->Gambar = new DbField('tentang', 'tentang', 'x_Gambar', 'Gambar', '`Gambar`', '`Gambar`', 200, -1, TRUE, '`Gambar`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		...
		// Isi
		$this->Isi = new DbField('tentang', 'tentang', 'x_Isi', 'Isi', '`Isi`', '`Isi`', 201, -1, FALSE, '`Isi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`tentang`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "tentangedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tentangadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tentangview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tentangview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tentangadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tentangadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tentangedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tentangadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tentangdelete.php", $this->getUrlParm());
	}
