 ...
 * Page class
 */
class layanan_view extends layanan
{
	...
	// Page object name
	public $PageObjName = "layanan_view";
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->terminate("layananlist.php"); // Return to list page
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "layananlist.php"; // No matching record, return to list
					} else {
						$this->loadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$returnUrl = "layananlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
