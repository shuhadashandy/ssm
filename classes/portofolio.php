...
/**
 * Table class for portofolio
 */
class portofolio extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'portofolio';
		$this->TableName = 'portofolio';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`portofolio`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new DbField('portofolio', 'portofolio', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Judul
		$this->Judul = new DbField('portofolio', 'portofolio', 'x_Judul', 'Judul', '`Judul`', '`Judul`', 200, -1, FALSE, '`Judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Isi
		$this->Isi = new DbField('portofolio', 'portofolio', 'x_Isi', 'Isi', '`Isi`', '`Isi`', 201, -1, FALSE, '`Isi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// Gambar
		$this->Gambar = new DbField('portofolio', 'portofolio', 'x_Gambar', 'Gambar', '`Gambar`', '`Gambar`', 200, -1, TRUE, '`Gambar`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		...
		// Gambar2
		$this->Gambar2 = new DbField('portofolio', 'portofolio', 'x_Gambar2', 'Gambar2', '`Gambar2`', '`Gambar2`', 200, -1, FALSE, '`Gambar2`', FALSE, FALSE, FALSE, 'IMAGE', 'TEXT');
		$this->Gambar2->Sortable = TRUE; // Allow sort
		$this->fields['Gambar2'] = &$this->Gambar2;

		// Gambar3
		$this->Gambar3 = new DbField('portofolio', 'portofolio', 'x_Gambar3', 'Gambar3', '`Gambar3`', '`Gambar3`', 200, -1, FALSE, '`Gambar3`', FALSE, FALSE, FALSE, 'IMAGE', 'TEXT');
		$this->Gambar3->Sortable = TRUE; // Allow sort
		$this->fields['Gambar3'] = &$this->Gambar3;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`portofolio`";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->Gambar3->DbValue = $row['Gambar3'];
	}
	...
	{
		global $Language;
		if ($pageName == "portofolioview.php")
			return $Language->phrase("View");
		elseif ($pageName == "portofolioedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "portofolioadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("portofolioview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("portofolioview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "portofolioadd.php?" . $this->getUrlParm($parm);
		else
			$url = "portofolioadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("portofolioedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("portofolioadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("portofoliodelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Gambar2->setDbValue($rs->fields('Gambar2'));
		$this->Gambar3->setDbValue($rs->fields('Gambar3'));
	}
	...
	public function renderListRow()
	{
		...
		if ($this->Gambar->UseColorbox) {
			...
			$this->Gambar->LinkAttrs["data-rel"] = "portofolio_x_Gambar";
		...
		// Gambar3
		$this->Gambar3->LinkCustomAttributes = "";
		$this->Gambar3->HrefValue = "";
		$this->Gambar3->TooltipValue = "";
	...
	public function renderEditRow()
	{
		...
		if (REMOVE_XSS)
			$this->Gambar2->CurrentValue = HtmlDecode($this->Gambar2->CurrentValue);
		$this->Gambar2->EditValue = $this->Gambar2->CurrentValue;
		$this->Gambar2->PlaceHolder = RemoveHtml($this->Gambar2->caption());

		// Gambar3
		$this->Gambar3->EditAttrs["class"] = "form-control";
		$this->Gambar3->EditCustomAttributes = "";
		if (REMOVE_XSS)
			$this->Gambar3->CurrentValue = HtmlDecode($this->Gambar3->CurrentValue);
		$this->Gambar3->EditValue = $this->Gambar3->CurrentValue;
		$this->Gambar3->PlaceHolder = RemoveHtml($this->Gambar3->caption());
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->Gambar3);
				}
				$doc->endExportRow();
			}
		}
