...
/**
 * Table class for layanan
 */
class layanan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'layanan';
		$this->TableName = 'layanan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`layanan`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new DbField('layanan', 'layanan', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Judul
		$this->Judul = new DbField('layanan', 'layanan', 'x_Judul', 'Judul', '`Judul`', '`Judul`', 200, -1, FALSE, '`Judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Gambar
		$this->Gambar = new DbField('layanan', 'layanan', 'x_Gambar', 'Gambar', '`Gambar`', '`Gambar`', 200, -1, TRUE, '`Gambar`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		...
		// Isi
		$this->Isi = new DbField('layanan', 'layanan', 'x_Isi', 'Isi', '`Isi`', '`Isi`', 201, -1, FALSE, '`Isi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`layanan`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "layananedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "layananadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("layananview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("layananview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "layananadd.php?" . $this->getUrlParm($parm);
		else
			$url = "layananadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("layananedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("layananadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("layanandelete.php", $this->getUrlParm());
	}
