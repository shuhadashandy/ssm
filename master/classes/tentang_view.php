 ...
 * Page class
 */
class tentang_view extends tentang
{
	...
	// Page object name
	public $PageObjName = "tentang_view";
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "tentanglist.php"; // No matching record, return to list
					} else {
						$this->loadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$returnUrl = "tentanglist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
