 ...
 * Page class
 */
class footerkiri_list extends footerkiri
{
	...
	// Page object name
	public $PageObjName = "footerkiri_list";

	// Grid form hidden field names
	public $FormName = "ffooterkirilist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "footerkiriadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "footerkiridelete.php";
		$this->MultiUpdateUrl = "footerkiriupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ffooterkirilistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->Isi2->AdvancedSearch->toJson(), ","); // Field Isi2
		...
		$filterList = Concat($filterList, $this->LinkedIn->AdvancedSearch->toJson(), ","); // Field LinkedIn
		if ($this->BasicSearch->Keyword <> "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ffooterkirilistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field Isi2
		$this->Isi2->AdvancedSearch->SearchValue = @$filter["x_Isi2"];
		$this->Isi2->AdvancedSearch->SearchOperator = @$filter["z_Isi2"];
		$this->Isi2->AdvancedSearch->SearchCondition = @$filter["v_Isi2"];
		$this->Isi2->AdvancedSearch->SearchValue2 = @$filter["y_Isi2"];
		$this->Isi2->AdvancedSearch->SearchOperator2 = @$filter["w_Isi2"];
		$this->Isi2->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->Isi2, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Phone, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->_Email, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Twitter, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Facebook, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Instagram, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->LinkedIn, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->Isi2); // Isi2
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew.submitAction(event,{f:document.ffooterkirilist,url:'" . $this->MultiDeleteUrl . "',data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->isLoggedIn());
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ffooterkirilistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ffooterkirilistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ffooterkirilist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ffooterkirilistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
