...
/**
 * Table class for footerkiri
 */
class footerkiri extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'footerkiri';
		$this->TableName = 'footerkiri';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`footerkiri`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// Id
		$this->Id = new DbField('footerkiri', 'footerkiri', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Judul
		$this->Judul = new DbField('footerkiri', 'footerkiri', 'x_Judul', 'Judul', '`Judul`', '`Judul`', 200, -1, FALSE, '`Judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Isi
		$this->Isi = new DbField('footerkiri', 'footerkiri', 'x_Isi', 'Isi', '`Isi`', '`Isi`', 200, -1, FALSE, '`Isi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Isi2
		$this->Isi2 = new DbField('footerkiri', 'footerkiri', 'x_Isi2', 'Isi2', '`Isi2`', '`Isi2`', 200, -1, FALSE, '`Isi2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Isi2->Nullable = FALSE; // NOT NULL field
		$this->Isi2->Required = TRUE; // Required field
		$this->Isi2->Sortable = TRUE; // Allow sort
		$this->fields['Isi2'] = &$this->Isi2;

		// Phone
		$this->Phone = new DbField('footerkiri', 'footerkiri', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, -1, FALSE, '`Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Email
		$this->_Email = new DbField('footerkiri', 'footerkiri', 'x__Email', 'Email', '`Email`', '`Email`', 200, -1, FALSE, '`Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Twitter
		$this->Twitter = new DbField('footerkiri', 'footerkiri', 'x_Twitter', 'Twitter', '`Twitter`', '`Twitter`', 200, -1, FALSE, '`Twitter`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Twitter->Sortable = TRUE; // Allow sort
		$this->fields['Twitter'] = &$this->Twitter;

		// Facebook
		$this->Facebook = new DbField('footerkiri', 'footerkiri', 'x_Facebook', 'Facebook', '`Facebook`', '`Facebook`', 200, -1, FALSE, '`Facebook`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Facebook->Sortable = TRUE; // Allow sort
		$this->fields['Facebook'] = &$this->Facebook;

		// Instagram
		$this->Instagram = new DbField('footerkiri', 'footerkiri', 'x_Instagram', 'Instagram', '`Instagram`', '`Instagram`', 200, -1, FALSE, '`Instagram`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Instagram->Sortable = TRUE; // Allow sort
		$this->fields['Instagram'] = &$this->Instagram;

		// LinkedIn
		$this->LinkedIn = new DbField('footerkiri', 'footerkiri', 'x_LinkedIn', 'LinkedIn', '`LinkedIn`', '`LinkedIn`', 200, -1, FALSE, '`LinkedIn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`footerkiri`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "footerkiriedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "footerkiriadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("footerkiriview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("footerkiriview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "footerkiriadd.php?" . $this->getUrlParm($parm);
		else
			$url = "footerkiriadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("footerkiriedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("footerkiriadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("footerkiridelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Isi2->setDbValue($rs->fields('Isi2'));
	...
	public function renderEditRow()
	{
		...
		$this->Isi2->EditValue = $this->Isi2->CurrentValue;
